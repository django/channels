...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if channel_backend.local_only:
            raise CommandError(
                "You have a process-local channel backend configured, and "
                "so cannot run separate interface servers.\n"
        ...
        try:
            ...
            from channels.interfaces.websocket_twisted import \
            ...
            from channels.interfaces.websocket_asyncio import \
