...
class RunServerTests(TestCase):
    ...
    def test_log_action(self, mocked_logger):
        ...
        test_actions = [
            ...
            (304, logging.INFO, cmd.style.HTTP_NOT_MODIFIED,
                'http', 'complete', 'HTTP GET /a-path/ 304 [0.12, a-client]'),
            (400, logging.WARN, cmd.style.HTTP_BAD_REQUEST,
                'http', 'complete', 'HTTP GET /a-path/ 400 [0.12, a-client]'),
            (404, logging.WARN, cmd.style.HTTP_NOT_FOUND,
                'http', 'complete', 'HTTP GET /a-path/ 404 [0.12, a-client]'),
            (500, logging.ERROR, cmd.style.HTTP_SERVER_ERROR,
                'http', 'complete', 'HTTP GET /a-path/ 500 [0.12, a-client]'),
